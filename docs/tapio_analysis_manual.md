...
- Any of the default settings defined in settings.py can be overrided in local_settings.py
...
## CD Analysis
- The CD analysis tools in Tapio Analysis are based on splitting a measurement of sample roll consisting multiple CD Strips separated by tapes into multiple CD profiles. The splitting is based on detecting the peaks caused by the tapes.
